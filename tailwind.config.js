    ...
    extend: {
      ...
      colors: {
        ...
        primary: {
          ...
          300: '#C390FF',
          400: '#AF6BFF',
          500: '#9A46FF', // Основний фіолетовий
          600: '#8429F0',
          700: '#6D12D9',
          800: '#5A00B3',
          900: '#46008C',
        ...
        secondary: {
          ...
          300: '#77CD8E',
          400: '#59C277',
          500: '#3CB760', // Такий самий як accent-500
          600: '#329C51',
          700: '#298243',
          800: '#206834',
          900: '#174D26',
        ...
        status: {
          success: '#3CB760', // Використовуємо наш світло-зелений
          warning: '#FFB800',
          error: '#FF4D6A',
          info: '#6C63FF', // Фіолетовий відтінок
        },
        scrollbar: '#1A1A26',
